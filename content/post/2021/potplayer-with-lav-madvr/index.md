...
去年写过一篇基本的 PotPlayer 设置教程，今年新显示器买到手了，是时候更新使用 madVR 的版本了。
...
![更改分辨率](20210828100937.webp)

![调整视频颜色设置](20210828100937.webp)
...
![勾选 H265 支持](20210828101028.webp)
...
![渲染器](20210828110012.webp)

"色系/属性" 选项卡，设置 YCbCr<->RGB 规则自动选择。

![转换规则](20210828110012.webp)
...
到这里为止，已经基本设置完毕了，打开视频按 Tab 键检查一下是否正常启用即可。具体设置项各人喜好不同也会有所不同，还请按照自己的喜好慢慢调整。

![视频测试](20210828101148.webp)
