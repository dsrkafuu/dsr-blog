...
export const SCRIPT_UTTERANCES = 'https://utteranc.es/client.js';

// comment
export const UTTERANCES_REPO = 'dsrsatori/dsr-comments';
export const UTTERANCES_TERM_PREFIX = 'dsr-blog';
export const UTTERANCES_LABEL = 'dsr-blog';
